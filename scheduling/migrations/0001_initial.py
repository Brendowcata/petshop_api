...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('animal', '0004_animalmodel_birth_date_animalmodel_gender_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clipping', models.CharField(blank=True, choices=[('TOSA_TESOURA', 'Tosa na Tesoura'), ('TOSA_MAQUINA', 'Tosa na Máquina'), ('TOSA_BEBE', 'Tosa Bebê'), ('TOSA_RACA', 'Tosa de Raça'), ('TOSA_VERAO', 'Tosa Verão'), ('TOSA_HIGIENICA', 'Tosa Higiênica'), ('TOSA_ESTETICA', 'Tosa Estética')], db_column='TYPE_CLIPPING', max_length=15, null=True)),
                ...
                ('dyeing', models.CharField(blank=True, choices=[('VERMELHO', 'Vermelho'), ('AMARELO', 'Amarelo'), ('AZUL', 'Azul'), ('VERDE', 'Verde'), ('LARANJA', 'Laranja'), ('ROXO', 'Roxo'), ('ROSA', 'Rosa'), ('BRANCO', 'Branco'), ('PRETO', 'Preto'), ('MARROM', 'Marrom'), ('CINZA', 'Cinza'), ('DOURADO', 'Dourado')], db_column='DYEING', max_length=8, null=True)),
